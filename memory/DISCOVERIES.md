...
[2026-05-11T23:35:00Z] BEHAVIOR | scruple-witness systemd unit has a drop-in override (/etc/systemd/system/scruple-witness.service.d/override.conf) setting STRIPE_SECRET_KEY + STRIPE_PUBLISHABLE_KEY to test-mode keys; live publishableKey is reachable via /api/stripe-config | no env wiring needed on scruple-web side; the proxy through witness "just works"
