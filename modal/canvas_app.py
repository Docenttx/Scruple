...
canvas_image = (
    ...
    .run_commands(
        ...
        # ComfyUI-Manager REMOVED — pin 3.7.5 crashed ComfyUI 0.18.5 on
        # boot ("Cannot connect to 8188" loop). Needs an older Manager
        # pin compatible with ComfyUI 0.18.x, or bump ComfyUI to a newer
        # tag that Manager supports.
