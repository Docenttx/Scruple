...
export async function POST(req: NextRequest) {
  ...
  // projects.witnessed_count update a few lines below correctly used
  // `leafHash ? 1 : 0`. The row and the counter disagreed. Standard §5
  // makes compliance binary; a fabricated 1 is the one thing that
  // cannot be allowed to reach the database.
  conn()
    .prepare(
